    ...
    <>
      ...
      <header className="header">
        <div className="header-brand">
          <img src="/CS.png" alt="Clean Sea" className="header-logo-img" />
          <div>
            <div className="header-main">Clean Sea</div>
      ...
      <div className="hero">
        <div className="hero-content">
          ...
          <p className="hero-desc" style={{ margin: "0 auto" }}>Gestión operativa y control de recursos.</p>
      ...
      <footer className="portal-footer">
        <div className="footer-left">Clean Sea · Confidencial</div>
